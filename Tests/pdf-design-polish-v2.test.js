...
const descriptionEnd = descriptionRun.x + descriptionRun.value.length * descriptionRun.size * 0.5;
assert.ok(impact.x > descriptionEnd, 'Risk description and structured labels must retain a visible inline separator.');
